...
@Injectable()
export class test_component_2Service {
    ...
    public gettest_component_2List(uid: string, projectHook: string) {
        //let headers = new Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        //let options = new RequestOptions({ headers: headers });
        //let objJson = JSON.stringify({ Uid: uid, ProjectHook: projectHook });
        //let apiroot = this.Config.apiKwanJaiURL + 'UnAuthorization/RequestOrder/ListFortest_component_2';
